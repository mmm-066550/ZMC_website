...
const departments = [
  ...
  },
  {
    ...
    name: "المنعكسات",
    enName: "reflexes",
    sum: "التحفيز العصبي الحسي الحركي لزيادة عدد المدخلات الحسية للدماغ لتطوير دماغ الطفل وتكامل المنعكسات للاطفال لتحسين مهاراتهم وقدراتهم",
  },
  {
    type: "departments",
    icon: "learn",
    name: "بطئ التعلم",
    enName: "slow-learning",
    sum: "تخدم وحدة بطئ التعلم الاطفال من ذوي القدرات أقل من المتوسط بمعدل ذكاء دون ٩٠حتى ٧٥ و ويعانون من مشاكل بالدراسة بوجه عام ومشاكل ادراكية ومشاكل بالذاكرة بوجه خاص",
  },
  {
    type: "departments",
    icon: "mon",
    ...
    enName: "day-care",
    sum: "يحصل الطفل داخل الفصل علي تعديل سلوك من خلال الجلسات الفردية والجماعية يوميا مكونات الادراك البصرى",
  },
];
